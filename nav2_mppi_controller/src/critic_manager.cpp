...
void CriticManager::getParams()
{
  ...
  // Read visualization parameters from TrajectoryVisualizer namespace
  auto getVisualizerParam = parameters_handler_->getParamGetter(name_ + ".TrajectoryVisualizer");
